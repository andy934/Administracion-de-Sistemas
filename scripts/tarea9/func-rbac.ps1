...
function Delegar-Politicas {
    ...
    Add-ADGroupMember -Identity "Propietarios del creador de directivas de grupo" -Members $usuario -ErrorAction SilentlyContinue
    Write-OK "  Agregado a Propietarios del creador de directivas de grupo (para crear/editar GPOs)"
...
function Delegar-Auditoria {
    ...
    Add-ADGroupMember -Identity "Lectores del registro de eventos" -Members $usuario -ErrorAction SilentlyContinue
    Write-OK "  Agregado a Lectores del registro de eventos"
