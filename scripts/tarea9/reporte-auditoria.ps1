...
function Configurar-Auditoria {
    ...
    # Usamos GUIDs para evitar errores de idioma/acentos en auditpol
    # {69979848-...} = Logon/Logoff
    # {6997984A-...} = Account Management
    # {6997984C-...} = Object Access
    auditpol /set /subcategory:"{0CCE9215-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # Logon
    auditpol /set /subcategory:"{0CCE9216-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # Logoff
    auditpol /set /subcategory:"{0CCE921B-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # Account Lockout
    auditpol /set /subcategory:"{0CCE9222-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # User Account Management
    auditpol /set /subcategory:"{0CCE9223-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # Computer Account Management
    auditpol /set /subcategory:"{0CCE9228-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # Other Account Management
    auditpol /set /subcategory:"{0CCE921A-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # File System (Object Access)
    auditpol /set /subcategory:"{0CCE9224-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable | Out-Null  # Security Group Management
